                            ...
                            <div class="col-md-4 product-men mt-5">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    ...
                                    <div class="item-info-product text-center border-top mt-4">
                                        <h4 class="pt-1">
                                            <a
                                                href="?quanli=chitietsp&id=<?php echo $row_product['product_id'] ?>&category=<?php echo $row_product['category_id'] ?>">
                                                <?php echo $row_product['product_name'] ?>
                                            </a>
                                        </h4>
                                        <div class="info-product-price my-2">
                                            <span
                                                class="item_price"><?php echo number_format($row_product['product_discount']) . ".đ" ?></span>
                                            ...
                                            <form action="?quanli=giohang" method="post">
                                                <fieldset>
                                                    ...
                                                    <input type="hidden" name="giasanpham"
                                                        value="<?php echo $row_product['product_discount'] ?>" />
                                                    <input type="hidden" name="hinhanh"
                                                        value="<?php echo $row_product['product_image'] ?>" />
                                                    <input type="hidden" name="soluong" value="1" />
                                                    <input type="submit" name="themgiohang" value="Thêm vào giỏ"
                                                        class="button" />
                                                </fieldset>
                                            </form>
                                            <?php else: ?>
                            ...
                            <div class="scroll">
                                ...
                                <div class="row p-2">
                                    ...
                                    <div class="col-lg-9 col-sm-10 col-9 w3_mvd">
                                        <a style="color: #333;"
                                            href=""><?php echo $row_product_sidebar['product_name'] ?></a><br>
                                        <a href=""
                                            class="price-mar mt-2"><?php echo number_format($row_product_sidebar['product_discount']) . '.đ' ?></a>
