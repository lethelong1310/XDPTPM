...
if (isset($_POST['themsanpham'])) {
    ...
    if ($fileSize > $allowedSize) {
        $error_message = "Kích thước ảnh quá lớn. Vui lòng tải lên ảnh nhỏ hơn 2 MB.";
    }
...
elseif (isset($_POST['capnhatsanpham'])) {
    ...
    if ($hinhanh == '') {
        ...
        $sql_update_product = "
            UPDATE product 
            SET product_name='$tensanpham', product_quantity='$soluong', product_price='$gia', 
                product_discount='$giakhuyenmai', product_details='$chitiet_escaped', 
                product_description='$mota', category_id='$danhmuc' 
        ...
        $sql_update_product = "
            UPDATE product 
            SET product_name='$tensanpham', product_image='$hinhanh_escaped', product_quantity='$soluong', 
                product_price='$gia', product_discount='$giakhuyenmai', product_details='$chitiet_escaped', 
                product_description='$mota', category_id='$danhmuc' 
            WHERE product_id='$id_update'";
        move_uploaded_file($hinhanh_tmp, $path . $hinhanh);
    }
...
if (isset($_GET['keyword']) && !empty($_GET['keyword'])) {
    ...
    $sql_select_sp = mysqli_query($mysqli, "
        SELECT * FROM product 
        INNER JOIN tbl_category ON product.category_id = tbl_category.category_id 
        WHERE product_name LIKE '%$keyword%' 
           OR product_description LIKE '%$keyword%'
           OR product_details LIKE '%$keyword%'
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">
                            ...
                            <span class="text-dark"> / Quản lí sản phẩm</span>
                        </h6>
                    </div>
                </div>
                    ...
                    <?php
                        ...
                        <div class="col-md-12">
                            ...
                            <?php if (isset($_GET['keyword']) && !empty($_GET['keyword'])): ?>
                                <h5 class="text-primary mb-3">Kết quả tìm kiếm cho: "<?php echo htmlspecialchars($_GET['keyword']); ?>"</h5>
                            <?php endif; ?>
                            ...
                            <table class="table table-bordered">
                                ...
                                ?>
                                    <tr class="text-center">
                                        ...
                                        <td><img style="max-width: 100px;" src="../images/<?php echo $row_sanpham['product_image'] ?>"></td>
                                        ...
                                        <td>
                                            <a href="?xoa=<?php echo $row_sanpham['product_id'] ?>" class="btn btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa sản phẩm này không?')">Xóa</a>
