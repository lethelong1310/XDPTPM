                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">
                                <a href="index.php">Dashboard</a><span class="text-dark"> / Tài khoản / Admin</span>
                            </h6>
                        </div>
                    ...
                    <div class="d-flex justify-content-center align-items-center mb-2">
                        <div class="d-flex mr-auto">
                            <a href="create_account_staff.php" class="btn btn-success">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table table-bordered">
                                ...
                                $sql_select_acount = mysqli_query($mysqli, "SELECT * FROM quanli_user WHERE role = 1 OR role = 2
                            ...
                            <?php
                            $sql_page = mysqli_query($mysqli, "SELECT * FROM quanli_user WHERE role = 1 OR role = 2 ");
                            ...
                            <div class="paging d-flex justify-content-center">
                                ...
                                for ($i = 1; $i <= $page; $i++) {
                                ?>
                                    <a <?php if ($i == $currentPage) echo 'style="background-color: #4e73df; border-color: #4e73df; color:white;"' ?> href="taikhoan_admin.php?page=<?php echo $i ?>"><?php echo $i ?></a>
                                <?php
                                }
                                ?>
